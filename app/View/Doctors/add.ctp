<div class="doctors form">
    ...
    <h1><?php echo __('Tambah Dokter'); ?></h1>

	<?php echo $this->Form->create('Doctor'); ?>

    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td width="20%"><label for="doctor_license_no"><?php echo __('No. Lisensi Dokter'); ?></label></td>
            <td>
				<?php
				echo $this->Form->input('doctor_license_no', array(
					'label' => false,
					'div' => false,
					'class' => 'text w_20'
				));
        ...
        <tr>
            <td><label for="doctor_specialty"><?php echo __('Spesialis dibidang'); ?></label></td>
            <td>
				<?php
				echo $this->Form->input('doctor_specialty', array(
					'label' => false,
					'div' => false,
					'class' => 'text w_20'
				));
	...
	<?php echo $this->element('btnSaveUpdate', array('formId' => 'DoctorAddForm', 'text' => __('Simpan'))); ?>    
