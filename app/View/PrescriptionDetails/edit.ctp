<div class="prescriptionDetails form">
    <h1><?php echo __('Ubah Rincian Obat'); ?></h1>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td id="cell_generic">
                <?php
                echo $this->Form->input('medicament_info', array(
                    'id' => 'medicament_info',
                    'label' => false,
                    'div' => false,
                    'class' => 'text w_40'
            ...
            <td id="cell_personalized">
                <?php
                echo $this->Form->input('personalized_medicine_info', array(
            ...
            <td id="cell_patent">
                <?php
                echo $this->Form->input('patent_medicine_info', array(
    ...
    <?php echo $this->element('btnSaveUpdate', array('formId' => 'PrescriptionDetailEditForm', 'text' => __('Ubah'), 'useReferer' => true)); ?>
