<div class="userRoles form">
    ...
    <h1><?php echo __('Ubah Hak Akses'); ?></h1>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td><input type="text" name="data[UserRole][role_name]" id="role_name" class="text w_20" maxlength="100" value="<?php echo $this->request->data['UserRole']['role_name']; ?>" /></td>
        </tr>
        <tr>
    ...
    <?php echo $this->element('btnSaveUpdate', array('formId' => 'UserRoleEditForm', 'text' => __('Ubah'))); ?>
