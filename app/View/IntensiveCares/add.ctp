<div class="intensiveCares form">

    <h1><?php echo __('Add Intensive Care'); ?></h1>

    <?php echo $this->Form->create('IntensiveCare');?>

    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                    <td width="20%"><label for="cause_of_accident"><?php echo __('cause_of_accident'); ?></label></td>
                    <td>
    ...
    <?php echo $this->element('btnSaveUpdate', array('formId' => 'IntensiveCareAddForm', 'text' => __('Save'))); ?>    
