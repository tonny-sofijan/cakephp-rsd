<div class="personalizedMedicines form">
    ...
    <h1><?php echo __('Ubah Obat Racik'); ?></h1>
        ...
        <tr>
            ...
            <td>
                <?php echo $this->Form->input('price_of_capital', array(
                    ...
                    'type' => 'text',
                    'value' => $this->Converter->formatNumber($this->request->data['PersonalizedMedicine']['price_of_capital'])
                )); ?>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?php echo $this->Form->input('selling_price', array(
                    ...
                    'class' => 'text w_10 numbersOnly autoNumeric',
                    'type' => 'text',
                    'value' => $this->Converter->formatNumber($this->request->data['PersonalizedMedicine']['selling_price'])
                )); ?>
            </td>
        </tr>
        <tr>
    ...
    <?php echo $this->element('btnSaveUpdate', array('formId' => 'PersonalizedMedicineEditForm', 'text' => __('Ubah'))); ?>    
