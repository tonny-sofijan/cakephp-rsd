<div class="patients form">
        ...
        <tr>
            ...
            <td>
				...
				echo $this->Form->input('Person.person_birth_date', array(
					...
					'value' => $this->Converter->formatDate($this->request->data['Person']['person_birth_date'], 'd-m-Y')
				))
				?>
            </td>
        </tr>
	...
	<?php echo $this->element('btnSaveUpdate', array('formId' => 'PatientEditForm', 'text' => __('Ubah'))); ?>    
