<div class="currencies form">
    ...
    <h2><?php echo __('Edit Currency'); ?></h2>    
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <td>
                                ...
                                <tr>
                    <td><label for="curr_name"><?php echo __('curr_name'); ?></label></td>
                    <td>
                    ...
                    <td>
                        ...
                        <?php echo $this->element('btnSaveUpdate', array('formId' => 'CurrencyEditForm', 'text' => __('Update'))); ?>    </table>
