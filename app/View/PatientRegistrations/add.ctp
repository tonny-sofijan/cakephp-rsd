<div class="patientRegistrations form">
            ...
            <tr>
                ...
                <td>
                    <?php echo $this->Form->select(
                        'registration_type', 
                        $this->Constant->getRegistrationType(), 
                        array(
                            'id' => 'registration_type', 
                            'empty' => false, 
                            'value' => isset($this->request->data['PatientRegistration']['registration_type']) ? $this->request->data['PatientRegistration']['registration_type'] : 'hospitalization'
                        )
                    ); ?>
                </td>
            </tr>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td>
                <?php echo $this->Form->input('patient_info', array(
                    'label' => false,
                    'div' => false,
                    'class' => 'text w_40 patient_info'
                )); ?>
            </td>
        </tr>
    ...
    <?php echo $this->element('btnSaveUpdate', array('formId' => 'PatientRegistrationAddForm', 'text' => __('Simpan'))); ?>
    <?php echo $this->Form->end(); ?>
</div>

<script type="text/javascript">
    $(document).ready(function() {
        $( ".patient_info" ).autocomplete({
            source: '/rsd/patients/autocomplete',
            minLength: 2,
        ...
        var regType = $('#registration_type option:selected').val();
        regTypeOnChange(regType);
        $('#registration_type').change(function() { regTypeOnChange($(this).val()); });
