<div class="checkouts form">
    <h1><?php echo __('Add Checkout'); ?></h1>

	<?php echo $this->Form->create('Checkout'); ?>

    <table width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<?php if ($patientRegistration['PatientRegistration']['registration_type'] != 'outpatient'): ?>
	...
	<?php echo $this->element('btnSaveUpdate', array('formId' => 'CheckoutAddForm', 'text' => __('Simpan'))); ?>
