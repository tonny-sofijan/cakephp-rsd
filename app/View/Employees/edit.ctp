<div class="employees form">
    ...
    <h1><?php echo __('Ubah Pegawai'); ?></h1>

	<?php echo $this->Form->create('Employee'); ?>

    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td width="20%"><label for="person_salutation"><?php echo __('Panggilan'); ?></label></td>
        ...
        <tr>
            <td><label for="position"><?php echo __('Jabatan'); ?></label></td>
            <td>
				<?php
	...
	<?php echo $this->element('btnSaveUpdate', array('formId' => 'EmployeeEditForm', 'text' => __('Ubah'))); ?>    
