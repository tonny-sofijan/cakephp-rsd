<div class="medicaments form">
        ...
        <tr>
            ...
            <td>
                <?php echo $this->Form->input('price_of_capital', array(
                    ...
                    'type' => 'text',
                    'value' => $this->Converter->formatNumber($this->request->data['Medicament']['price_of_capital'])
                )); ?>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?php echo $this->Form->input('selling_price', array(
                    ...
                    'class' => 'text w_10 numbersOnly autoNumeric',
                    'type' => 'text',
                    'value' => $this->Converter->formatNumber($this->request->data['Medicament']['selling_price'])
                )); ?>
            </td>
        </tr>
        <tr>
    ...
    <?php echo $this->element('btnSaveUpdate', array('formId' => 'MedicamentEditForm', 'text' => __('Ubah'))); ?>    
