<div class="mailLogs form">
    ...
    <h1><?php echo __('Add Mail Log'); ?></h1>

    <?php echo $this->Form->create('MailLog');?>

    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                    <td width="20%"><label for="mail_type"><?php echo __('mail_type'); ?></label></td>
                    <td>
    ...
    <?php echo $this->element('btnSaveUpdate', array('formId' => 'MailLogAddForm', 'text' => __('Save'))); ?>    
